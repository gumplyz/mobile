define(function (require, exports, module) {
    var c = require("./zepto"),
        d = function(a) {
            "no" != c(a.currentTarget).attr("data-event") && a.preventDefault(), a.stopPropagation();
        ...
        a = {
            ...
            _scrollStop: function() {
                c("body").addClass("f-ofh"), c(window).on("touchmove", this._scrollControl), c(window).on("scroll", this._scrollControl)
            },
            _scrollStart: function() {
                c("body").removeClass("f-ofh"), c(window).off("touchmove"), c(window).off("scroll")
            },
            ...
            refresh: function() {
                this._windowHeight = c(window).height(), this._windowWidth = c(window).width()
            }
        };
    return window.__GLOBAL = a, a
});